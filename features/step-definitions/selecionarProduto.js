...
Then(/^aparece a tela do produto "([^"]*)?" e o preco "([^"]*)?"$/, async (nomeProduto, precoProduto) => {
    ...
    const produtoPreco = '//android.widget.FrameLayout[@content-desc="Container for fragments"]/android.widget.ScrollView/android.view.ViewGroup/android.widget.TextView'
